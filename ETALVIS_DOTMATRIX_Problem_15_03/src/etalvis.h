...
uint8_t display_S[8] = {0x7e, 0x02, 0x02, 0x7e, 0x40, 0x40, 0x40, 0x7e};
uint8_t display_B[8] = {0x7e,0x42,0x42,0x3e,0x3e,0x42,0x42,0x7e};
...
void display()
{
  for(volatile long i = 1; i<=8; i++){
    send_2(i,i,display_S[i-1], display_B[i-1]);
  }
}