...
void display() {
  for(int i = 1; i<=8; i++){
    send_4_A(i,i,i,i,display_L[i-1],0,0,0);
    send_4_B(i,i,i,i,0,0,0,display_1[i-1]);
  }
  my_delay(100000);
  for(int i = 1; i<=8; i++){
    send_4_A(i,i,i,i,display_A[i-1],display_L[i-1],0,0);
    send_4_B(i,i,i,i,0,0,display_1[i-1],display_2[i-1]);
  }
  my_delay(100000);
  for(int i = 1; i<=8; i++){
    send_4_A(i,i,i,i,display_T[i-1],display_A[i-1],display_L[i-1],0);
    send_4_B(i,i,i,i,0,display_1[i-1],display_2[i-1],display_3[i-1]);
  }
  my_delay(100000);
  for(int i = 1; i<=8; i++){
