...
void display()
{
  for(volatile long j = 0; j<1000; j++){
    for(volatile long i = 1; i<=8; i++){
      send_4(i,i,i,i,display_4[i-1],0, 0, 0);
    }
  }

  for(volatile long j = 0; j<1000; j++){
    for(volatile long i = 1; i<=8; i++){
      send_4(i,i,i,i,display_3[i-1], display_4[i-1], 0, 0);
    }
  }

  for(volatile long j = 0; j<1000; j++){
    for(volatile long i = 1; i<=8; i++){
      send_4(i,i,i,i,display_2[i-1], display_3[i-1],display_4[i-1], 0);
    }
  }

  for(volatile long j = 0; j<1000; j++){
    for(volatile long i = 1; i<=8; i++){
      send_4(i,i,i,i,display_1[i-1], display_2[i-1],display_3[i-1],display_4[i-1] );
    }
  }

  for(volatile long j = 0; j<1000; j++){
    for(volatile long i = 1; i<=8; i++){
      send_4(i,i,i,i, 0, 0,0, 0);
    }
  }
}