...
// ---- TOP ROW ----
uint8_t top_S_1[8] = {0xFE, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0xFE};
uint8_t top_S_2[8] = {0x7F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7F};
uint8_t top_B_1[8] = {0xFF, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0xFF};
uint8_t top_B_2[8] = {0x3F, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x3F};

// ---- BOTTOM ROW ----
uint8_t bottom_S_1[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFE};
uint8_t bottom_S_2[8] = {0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x7F};
uint8_t bottom_B_1[8] = {0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0xFF};
uint8_t bottom_B_2[8] = {0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x3F};
...
void display() {
  for(int i = 1; i<=8; i++){
    send_4_A(i,i,i,i,top_S_1[i-1],top_S_2[i-1],top_B_1[i-1],top_B_2[i-1]);
    send_4_B(i,i,i,i,bottom_S_1[i-1],bottom_S_2[i-1],bottom_B_1[i-1],bottom_B_2[i-1]);
  }
  my_delay(500000);
  for(int i = 1; i<=8; i++){
    send_4_A(i,i,i,i,0,top_S_2[i-1],top_B_1[i-1],top_B_2[i-1]);
    send_4_B(i,i,i,i,0,bottom_S_2[i-1],bottom_B_1[i-1],bottom_B_2[i-1]);
  }
  my_delay(100000);
  for(int i = 1; i<=8; i++){
    send_4_A(i,i,i,i,0,0,top_B_1[i-1],top_B_2[i-1]);
    send_4_B(i,i,i,i,0,0,bottom_B_1[i-1],bottom_B_2[i-1]);
  }
  my_delay(100000);
  for(int i = 1; i<=8; i++){
    send_4_A(i,i,i,i,0,0,0,top_B_2[i-1]);
    send_4_B(i,i,i,i,0,0,0,bottom_B_2[i-1]);
  }
  my_delay(100000);
  for(int i = 1; i<=8; i++){
    send_4_A(i,i,i,i,0,0,0,0);
